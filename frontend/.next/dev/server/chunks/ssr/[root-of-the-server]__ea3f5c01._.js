...
const CHAIN_ID = process.env.NEXT_PUBLIC_CHAIN_ID ? parseInt(process.env.NEXT_PUBLIC_CHAIN_ID) : 31337 // Default to local
;
const BASE_SEPOLIA_RPC = process.env.NEXT_PUBLIC_BASE_SEPOLIA_RPC || "http://localhost:8545";
const LOCAL_RPC = "http://localhost:8545";
const CONTRACTS = {
    // Local Anvil deployment addresses
    REGISTRY: process.env.NEXT_PUBLIC_REGISTRY_ADDRESS || "0xdc64a140aa3e981100a9beca4e685f962f0cf6c9",
    MARKETPLACE: process.env.NEXT_PUBLIC_MARKETPLACE_ADDRESS || "0x0165878a594ca255338adfa4d48449f69242eb8f",
    COMPETITION: process.env.NEXT_PUBLIC_COMPETITION_ADDRESS || "0xa513e6e4b8f2a923d98304ec87f64353c4d5c853",
...
function getProvider() {
    ...
    const rpcUrl = process.env.NEXT_PUBLIC_CHAIN_ID === "31337" ? "http://localhost:8545" : __TURBOPACK__imported__module__$5b$project$5d2f$agent$2d$hedge$2d$fund$2f$frontend$2f$lib$2f$contracts$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["BASE_SEPOLIA_RPC"];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ea3f5c01._.js.map