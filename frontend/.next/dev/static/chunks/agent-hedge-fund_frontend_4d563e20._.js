        ...
        "useWallet.useCallback[connect]": async ()=>{
            ...
            try {
                ...
                if (("TURBOPACK compile-time value", "object") === "undefined" || !window.ethereum) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$agent$2d$hedge$2d$fund$2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("No wallet found. Please install MetaMask or another Web3 wallet.");
                    setState({
                        "useWallet.useCallback[connect]": (prev)=>({
                                ...prev,
                                isConnecting: false
                ...
                if (!address) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$agent$2d$hedge$2d$fund$2f$frontend$2f$node_modules$2f$react$2d$hot$2d$toast$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].error("No account found. Please unlock your wallet.");
                    setState({
                        "useWallet.useCallback[connect]": (prev)=>({
                                ...prev,
                                isConnecting: false
